...
{
public:
    static PeerConnectionObserver * Create(JumboMsgSender jumbo_msg_sender);
...
protected:
    PeerConnectionObserver(JumboMsgSender jumbo_msg_sender) : jumbo_msg_sender(jumbo_msg_sender) {};
